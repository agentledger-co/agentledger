 ...
 */
export function withAgentLedger(ledger, options, fn) {
    return async (...args) => {
 ...
 *   }
 */
export function createToolExecutor(ledger, agent, handlers, serviceMap) {
 ...
 */
export function wrapOpenAICompletion(ledger, agent, createFn) {
