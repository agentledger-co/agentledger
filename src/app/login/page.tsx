    ...
    <div className="min-h-screen bg-[#08080a] text-white flex items-center justify-center">
      <div className="max-w-sm w-full mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/30 text-[14px]">Sign in to AgentLedger</p>
        </div>
        ...
        <button
          ...
          className="w-full text-[12px] text-white/20 hover:text-white/40 transition-colors mt-4 text-center"
        >
