      ...
      <div className="max-w-sm w-full mx-4">
        ...
        <form onSubmit={handleSignup} className="space-y-3">
          <input
            ...
            required
            className="w-full bg-white/[0.12] border border-white/[0.20] rounded-lg px-4 py-2.5 text-[14px] text-white placeholder-white/50 focus:border-blue-500/60 focus:outline-none transition-colors"
          />
          <input
            type="password"
            value={password}
