        ...
        <table className="w-full text-[13px]">
          <thead>
            <tr className="border-b border-white/[0.14]">
              ...
              <th className="text-right text-[11px] text-white/30 font-medium px-4 py-2">Trend</th>
              <th className="text-right text-[11px] text-white/30 font-medium px-4 py-2">Budget</th>
              <th className="text-right text-[11px] text-white/30 font-medium px-4 py-2 hidden md:table-cell">Days Analyzed</th>
            </tr>
          </thead>
              ...
              <tr key={agent.agent} className="hover:bg-white/[0.06]">
                ...
                <td className="px-4 py-2 text-right">
                  {agent.budgetWarning ? (
                    ...
                    <span className="text-white/20 text-[11px]">No budget</span>
                  )}
                </td>
                <td className="px-4 py-2 text-right text-white/30 hidden md:table-cell">{agent.daysAnalyzed}d</td>
              </tr>
            ))}
          </tbody>
        </table>
