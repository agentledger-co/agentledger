      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          <input
            ...
            className="bg-white/[0.10] border border-white/[0.16] text-white/80 rounded-lg px-3 py-1.5 text-[12px] placeholder-white/50 focus:border-blue-500/50 focus:outline-none w-48"
          />
        </div>
      </div>
